...
Simple linear regression produces a 'line of best fit' using the two coefficients, $\beta_0$ and $\beta_1$ as defined above. This fit takes the form of $f(X) = \beta_0 + \beta_1 X + \epsilon$.
